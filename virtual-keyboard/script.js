...
let activeArr = ['Backquote', 'Digit1', 'Digit2', 'Digit3', 'Digit4', 'Digit5', 'Digit6', 'Digit7', 'Digit8', 'Digit9', 'Digit0', 'Minus', 'Equal', 'Backspace',
                'Tab', 'KeyQ', 'KeyW', 'KeyE', 'KeyR', 'KeyT', 'KeyY', 'KeyU', 'KeyI', 'KeyO', 'KeyP', 'BracketLeft', 'BracketRight', 'Backslash', 'Delete', 
                'CapsLock', 'KeyA', 'KeyS', 'KeyD', 'KeyF', 'KeyG', 'KeyH', 'KeyJ', 'KeyK', 'KeyL', 'Semicolon', 'Quote', 'Enter',
                'ShiftLeft', 'KeyZ', 'KeyX', 'KeyC', 'KeyV', 'KeyB', 'KeyN', 'KeyM', 'Comma', 'Period', 'Slash', 'ArrowUp', 'ShiftRight',
                'ControlLeft', 'null', 'AltLeft', 'Space', 'AltRight', 'ArrowLeft', 'ArrowDown', 'ArrowRight', 'ControlRight'];  
...
function openForm() {
    ...
    document.getElementById("popup_form").style.transition = '.8s';
    document.getElementById("popup_form").style.opacity = '1';
    document.getElementById("popup_form").style.right = '0';
    document.getElementById("popup_form").style.left = '0';
}
  
function closeForm() {
    document.getElementById("popup_form").style.visibility = "hidden";
    document.getElementById("popup_form").style.opacity = '0';
    document.getElementById("popup_form").style.left = '-3000px';
}


console.log('С самопроверкой можно ознакомиться нажав кнопку Info  либо в PR')